...
Se implementaron dos algoritmos de aprendizaje por refuerzo aprendidos en el curso para comparar su efectividad en Galaxian:
...
> Realmente el agente no fue entrenado desde el episodio 2,000 hasta el episodio 7,212 de corrido, se hizo por partes. Sin embargo, esta es una simplificación del proceso. 
...
3. La caída en la media de los últimos episodios sugiere que el modelo final no es óptimo
